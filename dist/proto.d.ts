...
export { enableWallet, getCurrentAccountAddress, getProviderInstance, sendAndWaitTx, sendTransaction, waitReceipt, toHex, toBN, IWalletProviderErrorCode, IWalletProviderError, };
